...
namespace SDKTemplate
{
    public sealed partial class Scenario1_EventAndMenuHookup : Page
    {
        ...
        private int prevActiveItemIndex;
        ...
        private void CreateMenuItems()
        {
            menuItems = new List<RadialControllerMenuItem>
            {
                ...
                RadialControllerMenuItem.CreateFromIcon("Num1", RandomAccessStreamReference.CreateFromUri(new Uri("ms-appx:///Assets/Num1.png"))),
                RadialControllerMenuItem.CreateFromIcon("Num2", RandomAccessStreamReference.CreateFromUri(new Uri("ms-appx:///Assets/Num2.png"))),
                RadialControllerMenuItem.CreateFromIcon("Num3", RandomAccessStreamReference.CreateFromUri(new Uri("ms-appx:///Assets/Num3.png")))
            };
        ...
        */
        ...
        {
            // save last activeItemIndex
            prevActiveItemIndex = activeItemIndex; //last menu item selected
            activeItemIndex = selectedItemIndex; //new menu item selected
